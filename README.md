...
Found a great free API? Open a PR to add it!

## Resources

- [public-apis/public-apis](https://github.com/public-apis/public-apis) - Massive community-curated list
- [Free Public APIs](https://www.freepublicapis.com/) - No-auth APIs collection
- [Apipheny Free API List](https://apipheny.io/free-api/) - 90+ public APIs
